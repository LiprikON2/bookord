...
// todo place title in title tooltip
const title =
    "Bookord app Bookord app Bookord app Bookord app Bookord app Bookord app Bookord app Bookord app Bookord Bookord app Bookord app Bookord app Bookord app";
...
const Titlebar = () => {
    ...
    const handleMinimize = (e) => {
        // todo fix button remaining active after click
        e.preventDefault();
