...
*/
console.log(
    "The translateMissing.js file must be updated before it can be ran."
);
return;
    ...
    try {
        ...
        for (const languageDirectory of languageDirectories) {
            ...
            try {
                ...
                const translationMissingExists = fs.existsSync(
                ...
                if (translationExists && translationMissingExists) {
                    ...
                    if (missingKeys.length > 0) {
                        ...
                        for (const missingKey of missingKeys) {
                            const googleTranslation = await translate.translate(
                                missingKey,
                                {
                                    from: fromLanguage,
